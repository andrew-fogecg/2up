...
- Board summary: HeadsOrTails uses a 5x3 layout with a clear primary action, review-ready help copy, and submission-friendly compliance panels.
...
### Game Flow
Set the play amount, trigger the primary action, and review results for HeadsOrTails through the history tray and help drawer.
